...
//             return this.updateSubject().then(() => super.save());
//         } else{
//             return this.addSubject().then(() => super.save());
...
//             this.animalSubjectService.createAnimalSubject(this.preclinicalSubject.animalSubject)z.then((animalSubject) => {
