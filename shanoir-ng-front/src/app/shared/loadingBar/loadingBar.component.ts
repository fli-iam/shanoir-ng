...
@Component({
    ...
    `,
    styles: [
        ':host() { position: relative; background-color: transparent; width: 200px; display: inline-block; height: 18px; border: 1px solid var(--grey); box-shadow: 0 0 4px 0 var(--grey) inset; }',
        '.inner { background-color: olivedrab; display: inline-block; height: 100%; }',
