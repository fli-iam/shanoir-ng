...
import {StudyTagDTO, SubjectStudyTagDTO, Tag} from '../../tags/tag.model';
...
export class SubjectStudyDTO {
    ...
    constructor(subjectStudy: SubjectStudy) {
        ...
        this.subjectStudyTags = subjectStudy.subjectStudyTags ? subjectStudy.subjectStudyTags.map(tag => new SubjectStudyTagDTO(new Id(this.id), tag)) : null;
    }
}
