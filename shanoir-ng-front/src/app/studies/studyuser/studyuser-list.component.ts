    ...
    private createColumnDefs(deleteButton: boolean) {
        this.columnDefs = [
            ...
            { headerName: 'Can review', type: 'boolean', editable: (su: StudyUser) => !this.disableEdit(su), width: '54px', disableSorting: true,
                onEdit: (su: StudyUser, value: boolean) => this.onEditRight(StudyUserRight.CAN_REVIEW, su, value),
                cellRenderer: (params: any) => params.data.studyUserRights.includes(StudyUserRight.CAN_REVIEW)},
