...
export class StudyComponent extends EntityComponent<Study> {
    ...
    buildForm(): FormGroup {
        let formGroup = this.formBuilder.group({
            ...
            'subjectTag': [this.study.subjectTag],
            'studyTag': [this.study.studyTag],
    ...
    save(): Promise<Study> {
      console.log("study component save");
