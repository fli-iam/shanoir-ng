            ...
            <ol>
                <li class="required">
                    ...
                    <span class="right-col">
                        <input *ngIf="userAccountRequestInfo" type="text" id="institution" required formControlName="institution" [(ngModel)]="userAccountRequestInfo.institution" readonly/>
                        <input *ngIf="!userAccountRequestInfo" type="text" id="institution" required readonly/>
                ...
                <li class="required">
                    ...
                    <span class="right-col">
                        <input *ngIf="userAccountRequestInfo" type="text" id="service" required formControlName="service" [(ngModel)]="userAccountRequestInfo.service" readonly/>
                        <input *ngIf="!userAccountRequestInfo" type="text" id="service" required readonly/>
                ...
                <li class="required">
                    ...
                    <span class="right-col">
                        <input *ngIf="userAccountRequestInfo" type="text" id="function" required formControlName="function" [(ngModel)]="userAccountRequestInfo.function" readonly/>
                        <input *ngIf="!userAccountRequestInfo" type="text" id="function" required readonly/>
                ...
                <li class="required">
                    ...
                    <span class="right-col">
                        <input *ngIf="userAccountRequestInfo" type="text" id="study" required formControlName="study" [(ngModel)]="userAccountRequestInfo.study" readonly/>
                        <input *ngIf="!userAccountRequestInfo " type="text" id="study" required readonly/>
                ...
                <li class="required">
                    ...
                    <span class="right-col">
                        <input *ngIf="userAccountRequestInfo" type="text" id="contact" required formControlName="contact" [(ngModel)]="userAccountRequestInfo.contact" readonly/>
                        <input *ngIf="!userAccountRequestInfo" type="text" id="contact" required readonly/>
                ...
                <li class="required">
                    ...
                    <span class="right-col">
                        <input *ngIf="userAccountRequestInfo" type="text" id="work" required formControlName="work" [(ngModel)]="userAccountRequestInfo.work" readonly/>
                        <input *ngIf="!userAccountRequestInfo" type="text" id="work" required readonly/>
