...
export enum DatasetExpressionFormat {
    ...
    ENHANCED_MR_IMAGE_STORAGE_SOP_CLASS = "",
    MR_SPECTROSCOPY_IMAGE_STORAGE_SOP_CLASS = "",
    ENHANCED_CT_IMAGE_STORAGE_SOP_CLASS = "",
    ENHANCED_PET_IMAGE_STORAGE_SOP_CLASS = "",
    SEGMENTATION_STORAGE_SOP_CLASS = "",
    DEFORMABLE_SPATIAL_REGISTRATION_STORAGE_SOP_CLASS = "",
    SPATIAL_REGISTRATION_STORAGE_SOP_CLASS = "",
    SIEMENS_SPECTROSCOPY = "",
    PHILIPS_SPECTROSCOPY = ""
