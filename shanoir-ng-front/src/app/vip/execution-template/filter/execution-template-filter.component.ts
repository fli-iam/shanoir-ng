...
export class ExecutionTemplateFilterComponent extends EntityComponent<ExecutionTemplateFilter> {
    ...
    buildForm(): FormGroup {
        this.executionFilterForm = this.formBuilder.group({
            'fieldName': [this.executionTemplateFilter.fieldName, [Validators.required, this.filterService.fieldNameFormatControl(this)]],
            'comparedRegex': [this.executionTemplateFilter.comparedRegex, [Validators.required, this.filterService.comparedRegexFormatControl(this)]],
            'identifier': [this.executionTemplateFilter.identifier, [Validators.required, this.filterService.uniqueInTemplateControl(this)]]
        })
