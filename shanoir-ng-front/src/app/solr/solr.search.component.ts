    ...
    private getCommonColumnDefs() {
        ...
        let columnDefs: ColumnDefinition[] = [
            ...
            {headerName: "OHIF Viewer", type: "button", awesome: "fa-solid fa-up-right-from-square",
              ...
              action: item => {
                window.open(environment.viewerUrl + '/viewer?StudyInstanceUIDs=1.4.9.12.34.1.8527.' + item.examinationId + '?SeriesInstanceUIDs=1.4.9.12.34.1.8527.' + item.datasetId, '_blank');
              }
            }
        ];
        return columnDefs;
