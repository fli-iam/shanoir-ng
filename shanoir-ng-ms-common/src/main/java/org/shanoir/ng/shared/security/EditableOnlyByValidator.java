 ...
 * @param <T>
 */
public class EditableOnlyByValidator {
	 ...
	 */
	public static <T extends AbstractEntity> FieldErrorMap validate(final T originalEntity, final T editedEntity) {
	 ...
	 * @return the forgotten fields names
	 */
	public static <T extends AbstractEntity> FieldErrorMap validate(final T editedEntity) {
		final Collection<String> connectedUserRoles = getConnectedUserRoles();
		final FieldErrorMap errorMap = new FieldErrorMap();
		try {
