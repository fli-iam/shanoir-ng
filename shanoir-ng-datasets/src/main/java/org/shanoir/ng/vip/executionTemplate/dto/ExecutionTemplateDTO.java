...
public class ExecutionTemplateDTO extends HalEntity {
    ...
    public List<ExecutionTemplateFilterDTO> getFilters() {
        return filters;
    }

    public void setFilters(List<ExecutionTemplateFilterDTO> filtersDTO) {
        this.filters = filtersDTO;
    }

    public List<ExecutionTemplateParameterDTO> getParameters() {
        return parameters;
    }

    public void setParameters(List<ExecutionTemplateParameterDTO> parametersDTO) {
