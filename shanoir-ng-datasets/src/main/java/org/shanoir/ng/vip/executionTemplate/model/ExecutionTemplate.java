...
public class ExecutionTemplate extends HalEntity {
    ...
    public List<ExecutionTemplateParameter> getParameters() {
        return parameters;
    }
    ...
    public void setPipelineName(String execution) {
        this.pipelineName = execution;
    }

    public List<ExecutionTemplateFilter> getFilters() {
        return filters;
    }
