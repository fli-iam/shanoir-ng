...
/**
 * Mapper for dataset processings.
 * 
 * @author msimon
 *
 */
...
public interface DatasetProcessingMapper {
	...
	/**
	 * Map a @DatasetProcessing to a @DatasetProcessingDTO.
	 * 
	 * @param dataset processing
	 *            dataset processing to map.
	 * @return dataset processing DTO.
	 */
	DatasetProcessingDTO datasetProcessingToDatasetProcessingDTO(DatasetProcessing datasetProcessing);
