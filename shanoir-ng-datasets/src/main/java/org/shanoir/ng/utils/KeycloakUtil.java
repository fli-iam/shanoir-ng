...
public final class KeycloakUtil {
	 ...
	 */
	public static Set<String> getTokenRoles() throws ShanoirDatasetException {
		final KeycloakSecurityContext context = getKeycloakSecurityContext();

		final AccessToken accessToken = context.getToken();
		if (accessToken == null) {
			throw new ShanoirDatasetException("Token not found");
		}
	 ...
	 * @throws ShanoirStudiesException
	 */
	public static Long getTokenUserId() throws ShanoirDatasetException {
		final KeycloakSecurityContext context = getKeycloakSecurityContext();
	 ...
	 * @throws ShanoirStudiesException
	 */
	public static HttpHeaders getKeycloakHeader() throws ShanoirDatasetException {
		final KeycloakSecurityContext context = getKeycloakSecurityContext();
	...
	private static KeycloakSecurityContext getKeycloakSecurityContext() throws ShanoirDatasetException {
		if (SecurityContextHolder.getContext().getAuthentication() instanceof AnonymousAuthenticationToken) {
			throw new ShanoirDatasetException("Anonymous user");
		}
