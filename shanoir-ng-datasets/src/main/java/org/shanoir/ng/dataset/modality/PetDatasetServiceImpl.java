 ...
 */
@Service
public class PetDatasetServiceImpl implements DatasetService<PetDataset> {

	/**
	 * Logger
	 */
	private static final Logger LOG = LoggerFactory.getLogger(PetDatasetServiceImpl.class);

	@Autowired
	private RabbitTemplate rabbitTemplate;

	@Autowired
	private PetDatasetRepository datasetRepository;
	...
	@Override
	public List<PetDataset> findBy(final String fieldName, final Object value) {
		return datasetRepository.findBy(fieldName, value);
	}

	@Override
	public PetDataset findById(final Long id) {
		return datasetRepository.findOne(id);
	}

	@Override
	public PetDataset save(final PetDataset dataset) throws ShanoirDatasetsException {
		PetDataset savedDataset = null;
		try {
	...
	@Override
	public PetDataset update(final PetDataset dataset) throws ShanoirDatasetsException {
		final PetDataset datasetDb = datasetRepository.findOne(dataset.getId());
	...
	@Override
	public void updateFromShanoirOld(final PetDataset dataset) throws ShanoirDatasetsException {
