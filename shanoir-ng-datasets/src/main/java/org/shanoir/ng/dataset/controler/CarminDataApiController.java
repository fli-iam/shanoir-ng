...
public class CarminDataApiController implements CarminDataApi{
    ...
    public ResponseEntity<?> getPath(
    		...
    		HttpServletResponse response) throws EntityNotFoundException, IOException, RestServiceException {
        ...
        switch (action){
            ...
            case "content":{
            	datasetDownloaderService.massiveDownload(format, Collections.singletonList(datasetService.findById(Long.parseLong(completePath))), response, false, null);
