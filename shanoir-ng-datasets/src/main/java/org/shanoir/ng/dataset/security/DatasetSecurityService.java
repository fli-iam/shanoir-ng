...
public class DatasetSecurityService {
	 ...
	 * @return true or false
	 */
	public boolean hasRightOnSubjects(List<Long> subjectIds, String rightStr) {
		if (isAdmin()) {
			return true;
		}
		for(Long subjectId : subjectIds) {
			if(!hasRightOnSubject(subjectId, rightStr)) {
				return false;
			}
		}
		return true;
	 ...
	 *
	 * @param subjectstudies the studies with subject datas
	 * @param rightStr the right
	 * @return true or false
	 */
	 ...
	 *
	 * @param datasetAcquisitions the dataset acquisitions
	 * @param rightStr the right
	 * @return true or false
	 * @throws EntityNotFoundException
	 */
	public boolean hasRightOnTrustedDatasetAcquisitions(List<DatasetAcquisition> datasetAcquisitions, String rightStr) throws EntityNotFoundException {
		if (KeycloakUtil.getTokenRoles().contains("ROLE_ADMIN")) {
			return true;
		}
	 ...
	 * @throws EntityNotFoundException
	 */
	public boolean hasRightOnAcquisitions(List<Long> datasetAcquisitionIds, String rightStr) throws EntityNotFoundException {
		...
		return hasRightOnTrustedDatasetAcquisitions(trustedDatasetAcquisitions, rightStr);
	}
	 ...
	 * @throws EntityNotFoundException
	 */
	public boolean hasRightOnDatasets(List<Long> datasetIds, String rightStr) throws EntityNotFoundException {
		if (KeycloakUtil.getTokenRoles().contains("ROLE_ADMIN")) {
			return true;
		}
		// If the entry is empty, return an empty list
	...
	/**
	 * Check the connected user has the given right for the given center and study.
	 * If the study is updated, check the user has the given right in both former and new study.
	 *
	 * @param centerId the center
	...
	/**
	 * Check the connected user has the given right for the given center and studies.
	 * If the studies are updated, check the user has the given right in both former and new studies.
	 *
	 * @param centerId the center
	 ...
	 *
	 * @param qualityCard the study card
	 * @param rightStr the right
	 * @return true or false
	 * @throws EntityNotFoundException
	 */
	...
	/**
	 * Check the connected user has the given right for the given card.
	 * If the card is updated, check the user has the given right in both former and new cards.
	 *
	 ...
	 * Filter examinations in that page checking the connected user has the right on those examinations.
	 *
	 * @param list the list of examinations
	 * @param rightStr the right
	 * @return true
	 */
	 ...
	 *
	 * @param list the list of dataset acquisitions
	 * @param rightStr the right
	 * @return true
	 */
	 ...
	 * Filter dataset acquisitions checking the connected user has the right on those.
	 *
	 * @param list the list of dataset acquisitions with examinations datas
	 * @param rightStr the right
	 * @return true
	 * @throws EntityNotFoundException
	 */
	 ...
	 * Filter examinations in that list checking the connected user has the right on those examinations.
	 *
	 * @param list the list of examinations with subject datas
	 * @param rightStr the right
	 * @return true
	 */
