...
public class DatasetServiceImpl implements DatasetService {
    ...
    /**
     * Called by acquisition delete. Does not reject from pacs as acquisition
     * already does it.
     *
     * @param id
     * @throws ShanoirException
    ...
    /**
     * Get study Id from dataset. If processed, recursively get it through
     * processing inputs
     *
     * @param dataset
     * @return
    ...
    /**
     * Get examination from dataset. If processed, recursively get it through
     * processing inputs
     *
     * @param dataset
     * @return
