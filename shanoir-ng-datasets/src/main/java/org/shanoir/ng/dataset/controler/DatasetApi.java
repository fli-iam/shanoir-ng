...
public interface DatasetApi {
	...
	ResponseEntity<Void> deleteDataset(
			@Parameter(name = "datasetId", description = "id of the dataset", required = true) @PathVariable Long datasetId)
    ...
    ResponseEntity<String> getDicomMetadataByDatasetId(
    		@Parameter(name = "datasetId", description = "id of the dataset", required=true) @PathVariable("datasetId") Long datasetId) throws MalformedURLException, IOException, MessagingException;
