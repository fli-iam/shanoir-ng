...
public interface DatasetApi {
	...
	ResponseEntity<List<DatasetDTO>> findDatasetsByExaminationId(@ApiParam(value = "id of the examination", required = true) @PathVariable("examinationId") Long examinationId);
