...
public interface DatasetCopyService {
    ...
    Object[] moveDataset(Dataset ds, Long studyId, SubjectIdMapping subjectMapping, Map<Long, Examination> examMap, Map<Long, DatasetAcquisition> acqMap, Long userId) throws Exception;
}
