...
public class UploadData {
	...
	/**
	 * If the type is \"File\", the base64 string will be decoded to a single raw
	 * file. If the type is \"Archive\", the base64 string must corresponds to an
	 * encoded zip file that will be decoded to create directory and its content.
	 * 
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(this.base64Content, uploadData.base64Content)
				&& Objects.equals(this.type, uploadData.type) && Objects.equals(this.md5, uploadData.md5);
	}
