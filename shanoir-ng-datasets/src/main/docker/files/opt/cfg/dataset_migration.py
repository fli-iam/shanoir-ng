...
sourceCursor.execute("SELECT n.SCORE_ID, "
 ...
 + "(SELECT LABEL_NAME FROM REF_UNIT_OF_MEASURE_ID r WHERE r.REF_UNIT_OF_MEASURE_ID = n.REF_UNIT_OF_MEASURE_ID)"
 )

query = "INSERT INTO numerical_score (id, ";
query+= "variable_assessment_id, ";
