...
public class ExaminationApiControllerTest {
	...
	public void setup() throws ShanoirException {
		...
		given(examinationServiceMock.findPage(Mockito.any(Pageable.class), Mockito.any(Boolean.class))).willReturn(new PageImpl<Examination>(Arrays.asList(new Examination())));
