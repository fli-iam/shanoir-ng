 ...
 * aspect into the import, that the BoutiquesApiController can directly answer.
 * 
 * @author mkain
 *
 */
@Service
public class BoutiquesManagerService {

	private static Logger LOG = LoggerFactory.getLogger(BoutiquesManagerService.class);
...
//	}
	 ...
	 */
	private File createImportJobDir(final String parent) {
		return new File(parent, "4");
	}
//	
//	/**
