...
public class RabbitMqConfiguration {
	...
	private final static String CENTER_QUEUE_NAME_IN = "center_queue";
	private final static String CENTER_QUEUE_NAME_OUT = "center_queue_from_ng";

    @Bean
    public static Queue queueIn() {
        return new Queue(CENTER_QUEUE_NAME_IN, true);
    }
    ...
    SimpleMessageListenerContainer container(final ConnectionFactory connectionFactory,
        ...
        container.setQueueNames(CENTER_QUEUE_NAME_IN);
