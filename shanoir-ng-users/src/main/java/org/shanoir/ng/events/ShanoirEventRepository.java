...
public interface ShanoirEventRepository extends CrudRepository<ShanoirEvent, Long> {
    ...
    /**
     * Find event by userId and eventType, filtered by date threshold.
     */
    List<ShanoirEvent> findByUserIdAndEventTypeInAndLastUpdateGreaterThan(
            Long userId, List<String> eventType, Date earlyDateThreshold);
