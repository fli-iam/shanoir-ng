...
public class AsyncTaskApiController implements AsyncTaskApi {
	...
	public ResponseEntity<List<ShanoirEventLight>> findTasks() {
		...
		List<ShanoirEventLight> taskList = taskService.getEventsByUserAndType(userId, ShanoirEventType.IMPORT_DATASET_EVENT, ShanoirEventType.EXECUTION_MONITORING_EVENT, ShanoirEventType.CHECK_QUALITY_EVENT);
