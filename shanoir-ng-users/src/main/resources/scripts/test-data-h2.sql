...
VALUES
	...
	(2, 0, 0, NOW(), 'jlouis@shanoir.fr', null, 'Julien', 0, 0, 0, 'Louis', '182413194A741C', 'jlouis', 2),
	(3, 0, 0, NOW(), 'yyao@shanoir.fr', null, 'Yao', 0, 0, 0, 'Yao', '51812A42578709', 'yyao', 2),
	(4, 0, 0, NOW(), 'jacques.martin@gmail.com', parsedatetime('2016/12/31', 'yyyy/MM/dd'), 'Jacques', 0, 0, 0, 'Martin', '92-1102B43C0-6', 'jmartin', 3),
	(5, 0, 0, NOW(), 'ricky.martin@gmail.com', null, 'Ricky', 0, 0, 0, 'Martin', '4165C7-57B4-76', 'wopa', 3),
	(6, 0, 0, NOW(), 'michel.sardou@gmail.com', null, 'Michel', 0, 0, 0, 'sardou', '1117DC-36DE-34', 'connemara', 3),
