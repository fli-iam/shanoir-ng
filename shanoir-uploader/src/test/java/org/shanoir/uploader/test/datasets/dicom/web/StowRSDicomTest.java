...
public class StowRSDicomTest extends AbstractTest {
    ...
    public void postDicomSRToDicomWeb() throws Exception {
        ...
        try {
            ...
            if (resource != null) {
                ...
                modifyAndCopyDicomFile(file, newFile, study.getId().toString(), subject.getName(),
                        UIDGeneration.ROOT + "." + examination.getId());
                // todo: add creation of acquisition and dataset (source)/or just create
                // independent dataset
    ...
    private void iterateOverFiles(File sourceDir, File destinationDir, String studyId, String patientName)
            throws IOException {
        if (sourceDir.isDirectory()) {
    ...
    private void modifyAndCopyDicomFile(File f, File newFile, String studyId, String patientName,
            String studyInstanceUID) throws IOException {
