...
public interface BidsImporterApi {
    ...
    @PostMapping(value = "/{studyId}/{studyName}/{centerId}/{equipmentId}",
    ...
    ResponseEntity<ImportJob> importAsBids(@ApiParam(value = "file detail") @RequestPart("file") MultipartFile bidsZipFile,
    		...
    		@ApiParam(value = "id of the equipment", required = true) @PathVariable("equipmentId") Long equipmentId) throws RestServiceException, ShanoirException, IOException;
