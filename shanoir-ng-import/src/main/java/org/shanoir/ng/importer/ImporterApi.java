...
public interface ImporterApi {
    ...
    @ApiOperation(value = "Import datasets from a BIDS folder", notes = "Import from bids", response = Void.class, tags={ "BIDS", "Import" })
    @ApiResponses(value = {
    ...
    ResponseEntity<ImportJob> importAsBids(@ApiParam(value = "file detail") @RequestPart("file") MultipartFile bidsZipFile) throws RestServiceException, ShanoirException, IOException, IOException;
