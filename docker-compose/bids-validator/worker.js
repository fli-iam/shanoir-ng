...
function runValidator(path) {
    return new Promise((resolve) => {
        ...
        execFile(
            "deno",
            // /app holds the worker's own package.json (amqplib): without this flag, Deno would resolve
            // the validator's npm dependencies from /app/node_modules instead of its pre-populated cache
            ["run", "--node-modules-dir=none", "-ERWN", `jsr:@bids/validator@${v}`, "--format", "json", path],
