...
targetConn = pymysql.connect(host="localhost", user="studies", password="password", database="studies", charset="utf8")

sourceCursor = sourceConn.cursor()
targetCursor = targetConn.cursor()

print("Attention: centers, study_center, ?studies?, ?study_user?, manufacturers, manufacturer models, acq-equipment, coils have already been migrated into ms studies.")
...
# waiting for decision to delete this table and feature
