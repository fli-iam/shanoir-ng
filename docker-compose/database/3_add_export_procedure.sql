...
begin
    ...
    and (subjectNameOutRegExp is null or subjectNameOutRegExp = '' or sb.name not rlike subjectNameOutRegExp)
    and st.name rlike if(studyNameInRegExp is null or studyNameInRegExp = '', '.*', studyNameInRegExp)
    and (studyNameOutRegExp is null or studyNameOutRegExp = '' or st.name not rlike studyNameOutRegExp);
end //
