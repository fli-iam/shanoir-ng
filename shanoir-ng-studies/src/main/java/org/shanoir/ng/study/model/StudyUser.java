...
public class StudyUser extends AbstractEntity {
	...
	@NotNull
	private Integer studyUserRight;
	...
	public StudyUserRight getStudyUserRight() {
		return StudyUserRight.getType(studyUserRight);
	}
	...
	public void setStudyUserRight(StudyUserRight studyUserRight) {
		if (studyUserRight != null) {
			this.studyUserRight = studyUserRight.getId();
		}
	}
