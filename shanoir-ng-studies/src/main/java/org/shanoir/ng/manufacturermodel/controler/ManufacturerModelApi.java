...
public interface ManufacturerModelApi {
	...
	ResponseEntity<ManufacturerModel> findManufacturerModelById(
			@Parameter(name = "manufacturerModelId", description = "id of the manufacturer model", required = true) @PathVariable("manufacturerModelId") Long manufacturerModelId);
	...
	@PreAuthorize("hasAnyRole('ADMIN', 'EXPERT', 'USER')")
	ResponseEntity<List<IdName>> findCenterManufacturerModelsNames(@Parameter(name = "centerId", description = "id of the center", required = true) @PathVariable("centerId") Long centerId);
