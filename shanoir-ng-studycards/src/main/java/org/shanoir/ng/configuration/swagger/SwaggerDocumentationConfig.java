...
public class SwaggerDocumentationConfig {
	...
	ApiInfo apiInfo() {
		return new ApiInfoBuilder().title("Shanoir NG Studies Microservice")
				.description("Microservice API for Shanoir NG study cards management").license("").licenseUrl("")
	...
	public Docket customImplementation() {
		...
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("org.shanoir.ng.studyCards.controller.rest")).build()
